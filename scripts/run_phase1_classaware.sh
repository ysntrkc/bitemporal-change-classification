...
python scripts/per_class_report.py \
  --prefixes phase1_object phase1_event phase1_attribute phase1_object_dbloss phase1_object_classaware \
  || echo "[warn] per_class_report.py failed"

echo
echo "[all-done] phase1_object_classaware suite complete"
