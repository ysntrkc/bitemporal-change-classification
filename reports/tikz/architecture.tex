\begin{figure*}[t]
  ...
  \caption{Aşama~1 (sol) ve Aşama~2 (sağ). Her iki yapı ConvNeXt-V2
    ...
    skaleri); loss'lar fixed task weights ile toplanır. Şekil yalnız
    her iki aşamanın kanonik yapılandırmasını gösterir; opsiyonel
    bileşenler (no-change gate, Query2Label heads, uncertainty-weighted
    loss) Tablo~\ref{tab:ablation}'de ablation satırları olarak
    raporlanır.}
  \label{fig:arch}
\end{figure*}